...
## Vorbereitung der Spaltenbenennung
...
## in der Praxis nimmt man eine Aussage erst fuer wahr wenn sie von 2 Channel bestaetigt wird
...
unscaled.arrhythmia <- cbind(arrhythmia.num,arrhythmia.bin)
...
scaled.arrhythmia <- cbind(arrhythmia.num,arrhythmia.bin)
...
write.csv(scaled.arrhythmia,paste0("C:/Users/David/Documents/Uni/Explorative Datenanalyse/1. Projekt/Daten/scaled.arrhythmia.csv"), row.names = FALSE)
write.csv(unscaled.arrhythmia,paste0("C:/Users/David/Documents/Uni/Explorative Datenanalyse/1. Projekt/Daten/unscaled.arrhythmia.csv"), row.names = FALSE)
